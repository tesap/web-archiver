...
TEST(html_parser_2) { ASSERT_EQUAL_INT(href_type("https://aur.archlinux.org/", NULL, "a"), HREF_TYPE_HTML); }
TEST(html_parser_3) { ASSERT_EQUAL_INT(href_type("/feed/packages/", NULL, "a"), HREF_TYPE_HTML); }
TEST(html_parser_4) { ASSERT_EQUAL_INT(href_type("#title-anything", NULL, "a"), HREF_TYPE_HTML); }
